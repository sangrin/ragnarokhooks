...
if exist "C:\Users\kim\Desktop\Ragnarok - Copia\recv.asi" del "C:\Users\kim\Desktop\Ragnarok - Copia\recv.asi"  
echo.
...
if exist Recv\Release\recv.asi (
    ...
    copy Recv\Release\recv.asi "C:\Users\kim\Desktop\Ragnarok - Copia\"
    echo.
    echo ========================================
